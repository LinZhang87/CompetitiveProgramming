...
public class Dijkstra {
    public static int[] dijkstraShortestPaths(GraphNode[] graphNodes, int startNode) {
    ...
    public static int[] dijkstraShortestPaths(List<int[]>[] graphNodes, int startNode) {
        int[] distance = new int[graphNodes.length];
        boolean[] processed = new boolean[graphNodes.length];
        Arrays.fill(distance, Integer.MAX_VALUE);
        //distance[startNode] = 0;
        ...
        while(!minPq.isEmpty()) {
            ...
            processed[currNodeLabel] = true;
            for(int[] edge : graphNodes[currNodeLabel]) {
    ...
    public static void main(String[] args) {
        ...
        int[] distances = dijkstraShortestPaths(nodes, 0);
