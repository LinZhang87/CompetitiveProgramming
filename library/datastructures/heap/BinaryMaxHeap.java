...
public class BinaryMaxHeap<T> {
    ...
    /*
        ...
        bigger children node and call percolateDown recursively on the swapped child node.
     */
    private void percolateDown(List<HeapNode<T>> nodes, int idx) {
        ...
        if(maxIdx != idx) {
            ...
            nodes.set(idx, nodes.get(maxIdx));
            nodes.set(maxIdx, temp);
            percolateDown(nodes, maxIdx);
        }
    }
    ...
    private void percolateDown(int idx) {
        ...
        if(maxIdx != idx) {
            nodeIdx.put(allNodes.get(idx), maxIdx);
            nodeIdx.put(allNodes.get(maxIdx), idx);
            HeapNode<T> temp = allNodes.get(idx);
            allNodes.set(idx, allNodes.get(maxIdx));
            allNodes.set(maxIdx, temp);
